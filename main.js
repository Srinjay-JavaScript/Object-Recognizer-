...
function snap(){
    Webcam.snap(function(data_url){
        document.getElementById("photo").innerHTML = "<img src='"+ data_url + "' width='325' height='275' style='margin-top: 10px;' id='img'>";
    });
}
...
function identify(){
    imgGiven = document.getElementById("img");
...
function result(error, results){
    if (error){
       ...
       document.getElementById(resultName).style.backgroundColor = "rgb(214, 149, 189)";
    }
